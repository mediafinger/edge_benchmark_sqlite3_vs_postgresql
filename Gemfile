...
gem "pg" # Use PostgreSQL as the database for the scondary DB [https://www.postgresql.org]
...
gem "sqlite3", ">= 2.1" # Use sqlite3 as the database for the primary DB [https://www.sqlite.org]
